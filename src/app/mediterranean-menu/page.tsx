...
export default function MediterraneanMenuPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ ...formData, serviceType: "mediterranean-menu" }),
      });
      if (response.ok) {
        setIsSuccess(true);
  ...
  // Mediterranean-themed icons for categories
  const categoryIcons: { [key: string]: ReactNode } = {
    Starter: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.5">
        ...
        <path d="M12 8c0-2 1-4 3-4s3 2 3 4c0 1-1 2-3 2" />
        <path d="M12 8c0-2-1-4-3-4S6 6 6 8c0 1 1 2 3 2" />
        <path d="M12 8v6" />
      </svg>
    ),
    "Main Course": (
    ...
    Dessert: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.5">
        <path d="M8 2h8l-1 5H9L8 2z" />
        <path d="M6 7h12c0 4-2 8-6 10-4-2-6-6-6-10z" />
        <path d="M9 17l-1 5h8l-1-5" />
        <path d="M12 12v5" />
      </svg>
    ),
  };
      ...
      <main>
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center pt-24 pb-16 lg:pt-32 lg:pb-24 vignette">
          ...
          <div className="absolute inset-0">
            <Image
              src="/images/hero-menus/Mediterranean.jpg"
          ...
          <div className="container relative">
            ...
            >
              ...
              <motion.div variants={staggerItem} className="text-center mb-12">
                ...
                <h2 className="font-[family-name:var(--font-cormorant)] mt-4">Our Mediterranean Offerings</h2>
              </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center p-6">
                  ...
                  <p className="text-[var(--color-text-secondary)] text-sm">
                    Authentic Mediterranean flavors with local produce
                  </p>
                </div>
                <div className="text-center p-6">
                  <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center border border-[var(--color-accent)] rounded-full">
                  ...
                  <p className="text-[var(--color-text-secondary)] text-sm">
                    Vegetarian alternatives available upon request
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-[var(--color-text-secondary)] mt-4 max-w-xl mx-auto">
                A glimpse into our sun-kissed cuisine and the memorable dining experiences we create
              </p>
            </motion.div>
            ...
            >
              {[
                { src: "/images/Sxmunchies-n-sweets-villa-1-680x800.jpg", alt: "Mediterranean dining 1" },
                { src: "/images/Sxmunchies-n-sweets-villa-2.jpg", alt: "Mediterranean dining 2" },
                { src: "/images/Sxmunchies-n-sweets-villa-4.jpg", alt: "Mediterranean dining 3" },
                { src: "/images/Sxmunchies-n-sweets-villa-6.jpg", alt: "Mediterranean dining 4" },
                { src: "/images/Sxmunchies-n-sweets-villa-7.jpg", alt: "Mediterranean dining 5" },
                { src: "/images/villa-service.jpg", alt: "Mediterranean dining 6" },
                { src: "/images/gourmet-day-beach.png", alt: "Mediterranean dining 7" },
                { src: "/images/home-page-private-chef-st-martin.jpg", alt: "Mediterranean dining 8" },
              ].map((image, idx) => (
                <motion.div
                  key={idx}
                  variants={staggerItem}
          ...
          <div className="container relative">
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <h2 className="mb-4 golden-glow-text">Tempted by our Mediterranean Menu?</h2>
                <p className="text-[var(--color-text-secondary)] max-w-xl mx-auto">
                  Let us bring the flavors of the Mediterranean coast to your villa or yacht
                </p>
              </motion.div>
