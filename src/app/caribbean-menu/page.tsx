...
export default function CaribbeanMenuPage() {
  const menu = menus.find((m) => m.slug === "caribbean-menu");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ ...formData, serviceType: "caribbean-menu", _turnstileToken: turnstileToken }),
      });
      if (response.ok) {
        setIsSuccess(true);
      ...
      <main>
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center pt-24 pb-16 lg:pt-32 lg:pb-24 vignette">
          ...
          <div className="absolute inset-0">
            <Image
              src="/images/hero-menus/Caribbean.jpg"
              alt="Caribbean Menu"
              fill
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center p-6">
                  <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center border border-[var(--color-accent)] rounded-full">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.5">
                      <path d="M12 3c-4.97 0-9 3.58-9 8 0 1.6.47 3.09 1.28 4.34L3 21l5.66-1.28A9.6 9.6 0 0 0 12 20c4.97 0 9-3.58 9-8s-4.03-9-9-9z" />
                      <path d="M8 12h.01M12 12h.01M16 12h.01" />
                    </svg>
                  </div>
                  <h4 className="text-[var(--color-text-primary)] mb-2">Authentic Flavors</h4>
                  <p className="text-[var(--color-text-secondary)] text-sm">
                    Traditional Caribbean recipes with local spices
                  </p>
                </div>
                <div className="text-center p-6">
                  <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center border border-[var(--color-accent)] rounded-full">
          ...
          <div className="container">
            ...
            >
              ...
              <h2 className="font-[family-name:var(--font-cormorant)] mt-4">
                Caribbean Culinary Moments
              </h2>
              <p className="text-[var(--color-text-secondary)] mt-4 max-w-xl mx-auto">
                A glimpse into the vibrant flavors and tropical experiences we bring to your table
              </p>
            </motion.div>
            ...
            >
              {[
                { src: "/images/hero-menus/Caribbean.jpg", alt: "Caribbean cuisine 1" },
                { src: "/images/grill-menu/image00001-3-950x800.jpg", alt: "Caribbean cuisine 2" },
                { src: "/images/grill-menu/image00002-4-950x800.jpg", alt: "Caribbean cuisine 3" },
                { src: "/images/grill-menu/image00003-3-950x800.jpg", alt: "Caribbean cuisine 4" },
                { src: "/images/grill-menu/image00004-4-950x800.jpg", alt: "Caribbean cuisine 5" },
                { src: "/images/grill-menu/image00005-3-950x800.jpg", alt: "Caribbean cuisine 6" },
                { src: "/images/grill-menu/image00006-3-950x800.jpg", alt: "Caribbean cuisine 7" },
                { src: "/images/grill-menu/image00007-3-950x800.jpg", alt: "Caribbean cuisine 8" },
              ].map((image, idx) => (
                <motion.div
                  key={idx}
                  variants={staggerItem}
          ...
          <div className="container relative">
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <h2 className="mb-4 golden-glow-text">Ready to savor the Caribbean?</h2>
                <p className="text-[var(--color-text-secondary)] max-w-xl mx-auto">
                  Let us bring the vibrant flavors of the islands to your villa or yacht
                </p>
              </motion.div>
        ...
        <RelatedMenus currentSlug="caribbean-menu" />
      </main>
      <Footer />
    </>
  );
