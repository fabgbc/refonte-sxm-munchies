            ...
            >
              ...
              <ul className="space-y-4 max-w-md mx-auto">
                <li className="flex items-center gap-3 text-[var(--color-text-secondary)]">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" className="flex-shrink-0">
                    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
                    <circle cx="9" cy="7" r="4" />
                    <path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />
                  </svg>
                  Minimum order: 4 guests
                </li>
                <li className="flex items-center gap-3 text-[var(--color-text-secondary)]">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" className="flex-shrink-0">
                  ...
                  Delivered ready to serve, with all sauces and condiments included
                </li>
                <li className="flex items-center gap-3 text-[var(--color-text-secondary)]">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" className="flex-shrink-0">
                  ...
                  Ideal for cocktail receptions, brunches, or villa aperitifs
                </li>
                <li className="flex items-center gap-3 text-[var(--color-text-secondary)]">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" className="flex-shrink-0">
          ...
          <div className="container relative">
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <ServiceContactForm serviceType="gourmet-platters" />
              </motion.div>
            </div>
          </div>
        </section>
