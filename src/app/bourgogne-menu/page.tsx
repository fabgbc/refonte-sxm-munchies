          ...
          <div className="container relative">
            ...
            >
              ...
              <motion.div variants={staggerItem} className="text-center mb-12">
                ...
                <h2 className="font-[family-name:var(--font-cormorant)] mt-4">Our Burgundy Journey</h2>
              </motion.div>
                        ...
                        {course.items.map((item, itemIndex) => (
                          ...
                          >
                            ...
                            <span className="text-[var(--color-accent)] font-[family-name:var(--font-cormorant)] text-xl italic whitespace-nowrap">
                              {/* Wine glass icon for Burgundy theme */}
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.5" className="inline-block">
