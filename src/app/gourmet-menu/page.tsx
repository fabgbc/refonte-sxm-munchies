          ...
          <div className="container relative">
            ...
            >
              ...
              <motion.div variants={staggerItem} className="text-center mb-12">
                ...
                <h2 className="font-[family-name:var(--font-cormorant)] mt-4">The Four-Course Journey</h2>
              </motion.div>
                    ...
                    >
                      ...
                      <ul className="space-y-4">
                        {course.items.map((item, itemIndex) => (
                          <li
                            key={itemIndex}
                            className="group flex items-center gap-4 pb-4 border-b border-[var(--color-accent-light)]/30 hover:border-[var(--color-accent)] transition-colors"
                          >
