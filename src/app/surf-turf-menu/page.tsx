  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ ...formData, serviceType: "surf-turf-menu" }),
      });
      if (response.ok) {
        setIsSuccess(true);
      ...
      <main>
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center pt-24 pb-16 lg:pt-32 lg:pb-24 vignette">
          ...
          <div className="absolute inset-0">
            <Image
              src="/images/hero-menus/Surf-Turf.jpg"
              alt="Surf & Turf Menu"
              fill
          ...
          <div className="container relative">
            ...
            >
              ...
              <motion.div variants={staggerItem} className="text-center mb-12">
                ...
                <h2 className="font-[family-name:var(--font-cormorant)] mt-4">Our Surf & Turf Experience</h2>
              </motion.div>
                  ...
                  {menu.courses.map((course, index) => (
                    <motion.div key={index} variants={staggerItem} className="relative">
                      <div className="flex items-center gap-4 mb-10">
                        ...
                        {course.category.toLowerCase().includes('seafood') || course.category.toLowerCase().includes('surf') || course.category.toLowerCase().includes('fish') || course.category.toLowerCase().includes('lobster') || course.category.toLowerCase().includes('crab') || course.category.toLowerCase().includes('shrimp') ? (
                          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.5">
                            <path d="M2 12c0 0 2-6 10-6s10 6 10 6" />
                            <path d="M2 12c0 0 2 6 10 6s10-6 10-6" />
                            <circle cx="7" cy="12" r="1" fill="var(--color-accent)" />
                            <path d="M22 12h-4" />
                            <path d="M18 10l2 2-2 2" />
                          </svg>
                        ) : course.category.toLowerCase().includes('meat') || course.category.toLowerCase().includes('turf') || course.category.toLowerCase().includes('beef') || course.category.toLowerCase().includes('steak') ? (
                          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.5">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="text-center p-6">
                  ...
                  <h4 className="text-[var(--color-text-primary)] mb-2">Ocean Fresh</h4>
                  <p className="text-[var(--color-text-secondary)] text-sm">
                    Premium seafood sourced from local waters
                  </p>
                </div>
                <div className="text-center p-6">
                  <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center border border-[var(--color-accent)] rounded-full">
                  ...
                  <h4 className="text-[var(--color-text-primary)] mb-2">Premium Cuts</h4>
                  <p className="text-[var(--color-text-secondary)] text-sm">
                    Finest meats paired with ocean delicacies
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-[var(--color-text-secondary)] mt-4 max-w-xl mx-auto">
                Where the ocean meets the land - a symphony of flavors crafted with passion
              </p>
            </motion.div>
            ...
            >
              {[
                { src: "/images/surf-turf-menu/image00001-2-900x800.jpg", alt: "Surf & Turf 1" },
                { src: "/images/surf-turf-menu/image00002-2-950x800.jpg", alt: "Surf & Turf 2" },
                { src: "/images/surf-turf-menu/image00003-2-950x800.jpg", alt: "Surf & Turf 3" },
                { src: "/images/surf-turf-menu/image00004-2-950x800.jpg", alt: "Surf & Turf 4" },
                { src: "/images/surf-turf-menu/image00005-950x800.jpg", alt: "Surf & Turf 5" },
                { src: "/images/surf-turf-menu/image00006-950x800.jpg", alt: "Surf & Turf 6" },
                { src: "/images/surf-turf-menu/image00007-900x800.jpg", alt: "Surf & Turf 7" },
                { src: "/images/surf-turf-menu/image00008-950x800.jpg", alt: "Surf & Turf 8" },
                { src: "/images/surf-turf-menu/image00009-950x800.jpg", alt: "Surf & Turf 9" },
              ].map((image, idx) => (
                <motion.div
                  key={idx}
                  variants={staggerItem}
          ...
          <div className="container relative">
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <h2 className="mb-4 golden-glow-text">Ready to savor the Surf & Turf Menu?</h2>
                <p className="text-[var(--color-text-secondary)] max-w-xl mx-auto">
                  Let us bring the ultimate land and sea experience to your villa or yacht
                </p>
              </motion.div>
        ...
        <RelatedMenus currentSlug="surf-turf-menu" />
      </main>
      <Footer />
    </>
  );
