...
export const menus: Menu[] = [
  ...
  },
  {
    ...
    grillItems: {
      meats: [
        { name: "Rossini Twist", price: 18, description: "A slice of seared foie gras on a juicy beef patty" },
        { name: "Classic Cheeseburger", price: 17, description: "Possible with the Rossini Twist" },
        { name: "Duck Breast", price: 44, description: "Seasoned with cinnamon flavoured salt" },
        { name: "Royal Skewer 300g / 10.5 oz", price: 49, description: "With beef, duck, veal, lamb and chicken on a skewer" },
        { name: "Beef Prime Rib", price: 8, description: "Per 100g, for two to share" },
        { name: "Beef Tenderloin 500g / 17.5 oz", price: 75, description: "For meat lovers only!" },
        { name: "Beef Tenderloin 300g / 10.5 oz", price: 52, description: "At its best with the Rossini Twist" },
      ],
      seafood: [
        { name: "Shrimps Skewers", price: 22, description: "Marinated in sweet chilli sauce" },
        { name: "Tuna Steak", price: 32, description: "Try it with the Rossini Twist!" },
        { name: "Whole Snapper", price: 24, description: "With creole sauce" },
        { name: "Lobster", price: 11, description: "Per 100g, with herbs butter topped and grilled" },
      ],
      sides: [
        "Grilled vegetables",
        "Baked potatoes",
