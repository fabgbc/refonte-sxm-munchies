...
export const menus: Menu[] = [
  ...
  },
  {
    ...
    grillItems: {
      meats: [
        { name: "Rossini Twist", price: 15, description: "A slice of seared foie gras on top of your meat" },
        { name: "Classic Cheeseburger", price: 20, description: "Also possible with the Rossini Twist" },
